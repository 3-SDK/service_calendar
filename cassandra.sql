...
-- CREATE TABLE hotels (id int PRIMARY KEY, hotel_name text, views int, one_person_max_rooms int, two_person_max_rooms int, three_person_max_rooms int, four_person_max_rooms int, one_person_room_price int, one_person_room_discounted_price int, one_person_partner_names set<text>, two_person_room_price int, two_person_room_discounted_price int, two_person_partner_names set<text>, three_person_room_price int, three_person_room_discounted_price int, three_person_partner_names set<text>, four_person_room_price int, four_person_room_discounted_price int, four_person_partner_names set<text>);
